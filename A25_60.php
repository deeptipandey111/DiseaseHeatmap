...
<body>
<center><u>Age Group: 25-60</u></center><br>
...
$result = mysqli_query($con,"SELECT TechName FROM AgeGrp WHERE A25_60 !=''");
if($row=mysqli_fetch_array($result))
{
        echo "<label>Diseases affecting people of age group 25-60:<br><br>";
