...
<body>
<center><u>Age Group: 10-25</u></center><br>
...
$result = mysqli_query($con,"SELECT TechName FROM AgeGrp WHERE A10_25 !=''");
if($row=mysqli_fetch_array($result))
{
        echo "<label>Diseases affecting people of age group 10-25:<br><br>";
