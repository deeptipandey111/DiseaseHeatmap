...
<body>
<center><u>Age Group: 60+</u></center><br>
...
$result = mysqli_query($con,"SELECT TechName FROM AgeGrp WHERE A60P !=''");
if($row=mysqli_fetch_array($result))
{
        echo "<label>Diseases affecting people of age group 60+:<br><br>";
