...
<body>
<center><u>Age Group: 0-2</u></center><br>
...
$result = mysqli_query($con,"SELECT TechName FROM AgeGrp WHERE A0_2 !=''");
if($row=mysqli_fetch_array($result))
{
        echo "<label>Diseases affecting children of age group 0-2:<br><br>";
